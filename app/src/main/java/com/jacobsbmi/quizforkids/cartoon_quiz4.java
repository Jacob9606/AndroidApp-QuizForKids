...
public class cartoon_quiz4 extends AppCompatActivity {
    private TextView question4ContentTxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cartoon_quiz4);

        question4ContentTxt = findViewById(R.id.question4ContentTxt);
        ...
        if (cursor.moveToFirst()) {
            ...
            if (questionIndex >= 0 && option1Index >= 0 && option2Index >= 0 && option3Index >= 0 && correctAnswerIndex >= 0) {
                ...
                // 가져온 질문과 선택지를 화면에 표시
                question4ContentTxt.setText(question);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.playCartoon:
                ...
                Intent cartoonIntent = new Intent(cartoon_quiz4.this, cartoon_quiz1.class);
                startActivity(cartoonIntent);
                return true;

            case R.id.playAnimal:
                // animal_quiz1 액티비티로 이동하는 코드 작성
                Intent animalIntent = new Intent(cartoon_quiz4.this, animal_quiz1.class);
                startActivity(animalIntent);
                return true;

            case R.id.history:
                // history 액티비티로 이동하는 코드 작성
                Intent historyIntent = new Intent(cartoon_quiz4.this, history.class);
                startActivity(historyIntent);
                return true;

            case R.id.changePasswordMenu:
                // change_password 액티비티로 이동하는 코드 작성
                Intent changePasswordIntent = new Intent(cartoon_quiz4.this, change_password.class);
                startActivity(changePasswordIntent);
                return true;

            case R.id.instruction:
                // instruction 액티비티로 이동하는 코드 작성
                Intent instructionIntent = new Intent(cartoon_quiz4.this, instruction.class);
    ...
    private void next(int correctAnswer,int wrongAnswer){
        Intent intent = new Intent(this, cartoon_result.class);
    ...
    private void moveToNextQuestion() {
        // cartoon_result 액티비티로 이동
        Intent intent = new Intent(this, cartoon_quiz1.class);
        startActivity(intent);
    }

    private void moveToPreviousQuestion() {
        // cartoon_quiz3 액티비티로 이동
        Intent intent = new Intent(this, cartoon_quiz3.class);
        startActivity(intent);
    }
}
