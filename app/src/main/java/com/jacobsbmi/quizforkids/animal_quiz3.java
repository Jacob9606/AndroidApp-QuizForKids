...
public class animal_quiz3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.animal_quiz3);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(animal_quiz3.this, animal_quiz4.class);
        ...
        previousButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(animal_quiz3.this, animal_quiz2.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(answer.equals("")){
                    // 오답인 경우
                    Toast.makeText(animal_quiz3.this, "You are Wrong! Wrong answers: " + (++WrongAnswer), Toast.LENGTH_SHORT).show();
                    nextquestion(CorrectAnswer,WrongAnswer);
                }else if (answer.equals(filename)) {
                    // 정답인 경우
                    Toast.makeText(animal_quiz3.this, "You are correct! Correct answers: " + (++CorrectAnswer), Toast.LENGTH_SHORT).show();
                    nextquestion(CorrectAnswer,WrongAnswer);
                } else {
                    // 오답인 경우
                    Toast.makeText(animal_quiz3.this, "You are Wrong! Wrong answers: " + (++WrongAnswer), Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.playCartoon:
                ...
                Intent cartoonIntent = new Intent(animal_quiz3.this, cartoon_quiz1.class);
                startActivity(cartoonIntent);
                return true;

            case R.id.playAnimal:
                // animal_quiz1 액티비티로 이동하는 코드 작성
                Intent animalIntent = new Intent(animal_quiz3.this, animal_quiz1.class);
                startActivity(animalIntent);
                return true;

            case R.id.history:
                // history 액티비티로 이동하는 코드 작성
                Intent historyIntent = new Intent(animal_quiz3.this, history.class);
                startActivity(historyIntent);
                return true;

            case R.id.changePasswordMenu:
                // change_password 액티비티로 이동하는 코드 작성
                Intent changePasswordIntent = new Intent(animal_quiz3.this, change_password.class);
                startActivity(changePasswordIntent);
                return true;

            case R.id.instruction:
                // instruction 액티비티로 이동하는 코드 작성
                Intent instructionIntent = new Intent(animal_quiz3.this, instruction.class);
    ...
    private String getResourceName(int resourceId) {
       int count=resourceId;

        if (resourceId == 0) {
            return "";
        }
        Log.d("Q3 resourceID "+count , String.valueOf(resourceId));
    ...
    private void setRandomAnimalImage() {
        ...
        // animal_quiz1, animal_quiz2에서 사용된 이미지 파일명 가져오기

        String[] usedFilenames = getUsedFilenames();

        Log.d("CHECK FILE NAMES", Arrays.toString(usedFilenames));
    ...
    // animal_quiz1, animal_quiz2에서 사용된 이미지 파일명을 가져오는 함수
    private String[] getUsedFilenames() {
        ...
        String[] usedFilenames = new String[2];
