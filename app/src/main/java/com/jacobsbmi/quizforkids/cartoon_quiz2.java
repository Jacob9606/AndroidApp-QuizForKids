...
public class cartoon_quiz2 extends AppCompatActivity {
    private TextView question2ContentTxt;
...
//    private int wrongAnswer=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cartoon_quiz2);

        question2ContentTxt = findViewById(R.id.question2ContentTxt);
        ...
        if (cursor.moveToFirst()) {
            ...
            if (questionIndex >= 0 && option1Index >= 0 && option2Index >= 0 && option3Index >= 0 && correctAnswerIndex >= 0) {
               ...
               Answer = cursor.getInt(correctAnswerIndex);
                ...
                // 가져온 질문과 선택지를 화면에 표시
                question2ContentTxt.setText(question);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.playCartoon:
                ...
                Intent cartoonIntent = new Intent(cartoon_quiz2.this, cartoon_quiz1.class);
                startActivity(cartoonIntent);
                return true;

            case R.id.playAnimal:
                // animal_quiz1 액티비티로 이동하는 코드 작성
                Intent animalIntent = new Intent(cartoon_quiz2.this, animal_quiz1.class);
                startActivity(animalIntent);
                return true;

            case R.id.history:
                // history 액티비티로 이동하는 코드 작성
                Intent historyIntent = new Intent(cartoon_quiz2.this, history.class);
                startActivity(historyIntent);
                return true;

            case R.id.changePasswordMenu:
                // change_password 액티비티로 이동하는 코드 작성
                Intent changePasswordIntent = new Intent(cartoon_quiz2.this, change_password.class);
                startActivity(changePasswordIntent);
                return true;

            case R.id.instruction:
                // instruction 액티비티로 이동하는 코드 작성
                Intent instructionIntent = new Intent(cartoon_quiz2.this, instruction.class);
